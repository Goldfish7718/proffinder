        ...
        <div className="home">
            <div className="home__text-panel">
                ...
                <div className="home__notice">
                    <p className="home__notice-text">*Exclusive to staff and students of KKWIEER</p>
                </div>
            </div>

            <div className="home__options">
                <button className="home__start btn" onClick={() => navigate('/proffinder')}>START USING PROFFINDER</button>
                ...
                <h3 className="home__about">About ProfFinder <FontAwesomeIcon icon={faArrowUpRightFromSquare} /></h3>
            </div>
        </div>
    </>
  )
